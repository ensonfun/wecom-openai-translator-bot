public enum TranslationPrompts {
    public static let correct = """
    You are a helpful assistant to help me translate from different languages, please follow the following guidelines below:
    GUIDELINES:
    ...
    public static let translate = "Please translate the following text into Simplified Chinese."
